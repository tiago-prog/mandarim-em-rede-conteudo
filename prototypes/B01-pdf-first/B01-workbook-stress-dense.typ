...
#page[
  ...
  #panel(fill: warm, stroke: ochre)[
    #text(size: 12pt, weight: "bold", fill: navy)[Escolher um cumprimento conforme a situação, registrar a forma em hanzi e pinyin e escrever uma versão própria para usar em uma cena nova.]
    #v(5pt)
    #small[Você vai trabalhar com uma pessoa nova, uma professora, um grupo e uma chamada telefônica em situações simples do dia a dia.]
  ]
  #v(7pt)
  ...
  #grid(columns: (1fr, 1fr), gutter: 6pt,
    ...
    [#card([
      ...
      #v(3pt)
      #small[Escolha a forma adequada, escreva com apoio, leia a estrutura e use-a em uma cena nova criada por você.]
...
#page[
  ...
  #panel(fill: cream, stroke: navy)[
    #grid(columns: (1fr, 1fr), gutter: 8pt,
      ...
      [#card([
        ...
        #v(3pt)
        #align(center)[#text(size: 9pt)[Você demonstra respeito ao falar com uma professora ou com uma pessoa mais velha.]]
        #v(5pt)
  ...
  #panel(fill: mint, stroke: teal)[
    #small[Escolha uma das quatro cenas, explique rapidamente sua decisão e escreva a forma que você usaria nessa situação.]
    #v(4pt)
...
#page[
  ...
  #small[Leia cada hanzi, acompanhe o pinyin com atenção, observe o sentido e marque a situação em que você usaria cada palavra.]
  #v(5pt)
  #table(
...
#page[
  ...
  #panel(fill: mint, stroke: teal)[
    ...
    #v(4pt)
    #small[Tente escrever todas as formas antes de consultar a tabela dos cartões; depois compare e corrija o que for necessário.]
  ]
]
...
#page[
  ...
  #panel(fill: warm, stroke: ochre)[
    #small[Qual forma foi mais fácil de ler? Qual forma precisa de mais prática? Explique o motivo usando uma observação curta.]
    #v(4pt)
...
#page[
  ...
  #panel(fill: warm, stroke: ochre)[
    #small[Depois de tentar sem consultar, compare suas respostas com a página 4 e marque o que aconteceu durante a revisão.]
    #v(4pt)
    #grid(columns: (1fr, 1fr), gutter: 6pt,
...
#page[
  ...
  #panel(fill: warm, stroke: ochre)[
    #small[Escreva uma situação nova, indique quem está presente e registre a forma que combina com esse contexto.]
    #v(4pt)
    #writebox(height: 18mm, color: ochre)
  ]
]
  ...
  #panel(fill: cream, stroke: navy)[
    #grid(columns: (1fr, 1fr), gutter: 8pt,
      [#card([
        ...
        #v(4pt)
        Você chega a uma reunião de trabalho e precisa cumprimentar três pessoas diferentes, escolhendo uma forma adequada para cada relação.
        #v(6pt)
